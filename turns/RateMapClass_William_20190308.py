...
class RateMap():
    ...
    def findPlaceFields(self):
        ...
        def findUsefulInfo(self, PlaceFieldObject):
            ...
            # Find peakXY
            peakXY = (int(np.where(PF.field==PF.peakValue)[0]),int(np.where(PF.field==PF.peakValue)[1]))
            PF.peakXY = peakXY
