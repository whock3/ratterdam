...
for rat,day in zip(['R859','R859','R781','R781','R808','R808'],['D1','D2','D3','D4','D6','D7']):
    ...
    try:
        ...
        for target, label in zip([currentDir, previousDir, nextDir, traj],["CurrentDirection", "PreviousDirection", "NextDirection", "PCNTrajectory"]):
            print(target)
            realoobs, shuffoobs = [], []
            nreps = 10
            nshuffs = 500
            ...
            plt.savefig(savepath+f"21-07-14_{rat}{day}_{label}_RFDecoding.png")
            plt.close()
