...
# created by WH
R886V = np.asarray([87, 132, 218, 262, 352, 402, 490, 533]) #d2
R886H = np.asarray([83, 137, 210, 270, 350, 402]) #d2
...
v1, v2, v3, v4, v5, v6, v7, v8 = R886V
h1, h2, h3, h4, h5, h6 = R886H
...
R886 = alleyBounds(cityBlocks, alleyLines, alleyInterBounds, IAI)
...
R765 = alleyBounds(cityBlocks, alleyLines, alleyInterBounds, IAI)
