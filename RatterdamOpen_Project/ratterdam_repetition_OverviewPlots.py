...
for rat, day in zip(rat_list, day_list):
    ...
    for fieldPassThru in [False]:
        
        Def.includeAllDetectedFields = fieldPassThru 
        ...
        for unitname, unit in population.items():
            ...
            with PdfPages(savepath+date+"_"+unitname+f"overview_fieldpassthru{Def.includeAllDetectedFields}.pdf") as pdf:
