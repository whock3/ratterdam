...
R808V = [100, 141, 238, 283, 375, 418, 508, 543]
R808H = [88, 130, 217, 264, 362, 400]
...
alleyBounds = namedtuple("alleyBounds", "cityBlocks alleyLines alleyInterBounds")
R781 = alleyBounds(cityBlocks, alleyLines, alleyInterBounds)
...
R808 = alleyBounds(cityBlocks, alleyLines, alleyInterBounds)
...
R859 = alleyBounds(cityBlocks, alleyLines, alleyInterBounds)
